...
class MainPage(BackgroundPage):
    ...
    def add_widgets(self):
        ...
        self.contact=WhiteMessage(self.f,text="Our Details Here!")
        self.contact_detail=WhiteMessage(self.f,text=" Foodie Express,\n Shivnath Society\n Mumbai\n +91 9876543210",font=("Times New Roman", 15, "bold", "italic"))
    ...
    def redirect_to_page(self, result,login_type):
        ...
        if login_type == "Admin":
            ...
            import CustomerHomePage as c
            c.CustomerHomePage(self.root, result)
