...
class CustomerHomePage(BackgroundPage):
    ...
    def customer_logout(self):
        ...
        self.f.destroy()
        self.redirect = m.MainPage(self.root)
    ...
    def add_menu(self):
        ...
        self.raw_menu_image = Image.open('C:\\Users\\HP\\Desktop\\coding\\python projects\\Food Ordering-Simran\\Food Ordering\\images\\MenuBackground.jpg')
