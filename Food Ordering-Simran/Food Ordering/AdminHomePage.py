...
class AdminHomePage(BackgroundPage):
    ...
    def add_admin_details(self):
        ...
        print(self.details)
        self.admin_raw_image = Image.open('C:\\Users\\HP\\Desktop\\coding\\python projects\\Food Ordering-Simran\\Food Ordering\\images\\' + self.details.get("AdminPhoto"))
        self.admin_raw_image = self.admin_raw_image.resize((100, 100))
        ...
        self.c = Canvas(self.f, width=100, height=100)
...
if (__name__ == "__main__"):
    root = Tk()
    admin_details = {'AdminId': 1, 'AdminName': 'Simran', 'AdminPassword': 'SGT',
                     'AdminEmail': 'simmilahrani@gmail.com',
                     'AdminPhoto': 'user.jpg'}
