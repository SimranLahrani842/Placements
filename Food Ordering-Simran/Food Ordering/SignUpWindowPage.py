...
class SignUp:
    ...
    def add_header_section(self):
        ...
        self.raw_login_image = Image.open("C:\\Users\\HP\\Desktop\\coding\\python projects\\Food Ordering-Simran\\Food Ordering\\images\\login_icon.png")
        self.raw_login_image = self.raw_login_image.resize((200, 200))
        ...
        self.welcome_label = Label(self.header_frame, text="New User-Sign up", font = ("Monotype Corsiva",20,"bold","italic"))
