...
class BackgroundPage:
    def __init__(self, root):
        self.root = root
        self.root.iconbitmap('C:\\Users\\HP\\Desktop\\coding\\python projects\\Food Ordering-Simran\\Food Ordering\\images\\FoodIcon.ico')
        self.root.title('Foodie Express')
        # ensure that size of image is same as/greater than size of frame
        self.f = Frame(root, width=1600, height=900)
        self.f.pack()

        self.raw_image = Image.open('C:\\Users\\HP\\Desktop\\coding\\python projects\\Food Ordering-Simran\\Food Ordering\\images\\FoodBackground.jpg')
        ...
        # Add the message saying "Foodie Express"
        self.m = Message(self.f, width=600, font=("Monotype Corsiva", 20, "bold", "italic"), text="Foodie Express",
                         bg="white", relief=SOLID, borderwidth=2)
        self.m.place(x=520, y=20)
        # The footer at the bottom
        self.footer = Label(self.panel, bg="ivory3", height=1,
                            text="@Copyright 2022 Foodie Express. All rights reserved")
